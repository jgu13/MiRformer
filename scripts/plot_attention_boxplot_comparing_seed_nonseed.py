...
def main():
    ...
    # plot boxplots showing the distribution of attention weights within seed region and outside the seed region
    # Comparing 4 methods: global full attention, mean unchunked attention, norm by query, norm by key
    # save_boxplot_dir = os.path.join(PROJ_HOME, "Performance/TargetScan_test", "TwoTowerTransformer", str(mrna_max_len))
    # os.makedirs(save_boxplot_dir, exist_ok=True)
    # global_seed_weights_path = os.path.join(PROJ_HOME, f"Performance/TargetScan_test/TwoTowerTransformer/500/global_attention_{miRNA_ID}_{mRNA_ID}_seed_weights.pt")
    # global_non_seed_weights_path = os.path.join(PROJ_HOME,f"Performance/TargetScan_test/TwoTowerTransformer/500/global_attention_{miRNA_ID}_{mRNA_ID}_non_seed_weights.pt")
    # mean_unchunked_seed_weights_path = os.path.join(PROJ_HOME, f"Performance/TargetScan_test/TwoTowerTransformer/520/mean_unchunk_{miRNA_ID}_{mRNA_ID}_seed_weights.pt")
    # mean_unchunked_non_seed_weights_path = os.path.join(PROJ_HOME, f"Performance/TargetScan_test/TwoTowerTransformer/520/mean_unchunk_{miRNA_ID}_{mRNA_ID}_non_seed_weights.pt")
    # norm_by_query_seed_weights_path = os.path.join(PROJ_HOME, f"Performance/TargetScan_test/TwoTowerTransformer/520/norm_by_query_{miRNA_ID}_{mRNA_ID}_seed_weights.pt")
    # norm_by_key_seed_weights_path = os.path.join(PROJ_HOME, f"Performance/TargetScan_test/TwoTowerTransformer/520/norm_by_key_{miRNA_ID}_{mRNA_ID}_seed_weights.pt")
    # norm_by_query_non_seed_weights_path = os.path.join(PROJ_HOME, f"Performance/TargetScan_test/TwoTowerTransformer/520/norm_by_query_{miRNA_ID}_{mRNA_ID}_non_seed_weights.pt")
    # norm_by_key_non_seed_weights_path = os.path.join(PROJ_HOME, f"Performance/TargetScan_test/TwoTowerTransformer/520/norm_by_key_{miRNA_ID}_{mRNA_ID}_non_seed_weights.pt")

    # # do mann whitney u test between seed and non-seed
    # global_seed_weights = torch.load(global_seed_weights_path)
    # global_non_seed_weights = torch.load(global_non_seed_weights_path)
    # result = mannwhitneyu(global_seed_weights.flatten(), global_non_seed_weights.flatten())
    # print("Global attention:")
    # print("Mann-Whitney u test between seed and non-seed:")
    # print(f"statistic: {result.statistic}")
    # print(f"p-value: {result.pvalue}")
    # global_p_value = result.pvalue

    # mean_unchunked_seed_weights = torch.load(mean_unchunked_seed_weights_path)
    # mean_unchunked_non_seed_weights = torch.load(mean_unchunked_non_seed_weights_path)
    # result = mannwhitneyu(mean_unchunked_seed_weights.flatten(), mean_unchunked_non_seed_weights.flatten())
    # print("Mean unchunked attention:")
    # print("Mann-Whitney u test between seed and non-seed:")
    # print(f"statistic: {result.statistic}")
    # print(f"p-value: {result.pvalue}")
    
    # mean_unchunked_p_value = result.pvalue
    # norm_by_query_seed_weights = torch.load(norm_by_query_seed_weights_path)
    # norm_by_query_non_seed_weights = torch.load(norm_by_query_non_seed_weights_path)
    # result = mannwhitneyu(norm_by_query_seed_weights.flatten(), norm_by_query_non_seed_weights.flatten())
    # print("Norm by query attention:")
    # print("Mann-Whitney u test between seed and non-seed:")
    # print(f"statistic: {result.statistic}")
    # print(f"p-value: {result.pvalue}")
    
    # norm_by_query_p_value = result.pvalue
    # norm_by_key_seed_weights = torch.load(norm_by_key_seed_weights_path)
    # norm_by_key_non_seed_weights = torch.load(norm_by_key_non_seed_weights_path)
    # result = mannwhitneyu(norm_by_key_seed_weights.flatten(), norm_by_key_non_seed_weights.flatten())
    # print("Norm by key attention:")
    # print("Mann-Whitney u test between seed and non-seed:")
    # print(f"statistic: {result.statistic}")
    # print(f"p-value: {result.pvalue}")
    # norm_by_key_p_value = result.pvalue

    # p_values = {"global": f"{global_p_value:.4e}",
    #             "mean_unchunked": f"{mean_unchunked_p_value:.4e}", 
    #             "norm_by_query": f"{norm_by_query_p_value:.4e}", # print in scientific notation
    #             "norm_by_key": f"{norm_by_key_p_value:.4e}"}

    # plot the boxplots comparison
    # plot_attention_weights_boxplots_comparison(
    #     miRNA_id=miRNA_ID,
    #     mRNA_id=mRNA_ID,
    #     global_seed_weights_path=global_seed_weights_path,
    #     global_non_seed_weights_path=global_non_seed_weights_path,
    #     mean_unchunked_seed_weights_path=mean_unchunked_seed_weights_path,
    #     mean_unchunked_non_seed_weights_path=mean_unchunked_non_seed_weights_path,
    #     norm_by_query_seed_weights_path=norm_by_query_seed_weights_path,
    #     norm_by_query_non_seed_weights_path=norm_by_query_non_seed_weights_path,
    #     norm_by_key_seed_weights_path=norm_by_key_seed_weights_path,
    #     norm_by_key_non_seed_weights_path=norm_by_key_non_seed_weights_path,
    #     save_attention_weights_boxplot_dir=save_boxplot_dir,
    #     p_values=p_values
    # )
