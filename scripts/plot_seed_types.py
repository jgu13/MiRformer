...
data_path = os.path.join(data_dir, "mouse_positive_samples_30_randomized_start.csv")
...
prop_sorted.plot(kind='bar', stacked=True, ax=ax)
...
fig.savefig(os.path.join(data_dir, "mouse_Site_Types_proportion.png"), dpi=500, bbox_inches='tight')
